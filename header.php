...
<html <?php language_attributes(); ?>>
 <head>
   ...
   <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/images/icons/favicon144.png">
   <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/images/icons/favicon72.png">
   <meta name="theme-color" content="#501111">
        ...
        <aside>
            <header>
                <a href="<?php echo get_site_url(); ?>" class="logo" id="main-logo">
                    <span id="logo_pk"></span>
                    <!-- <img id="logo_pk" src="<?php echo get_template_directory_uri(); ?>/images/logo_.svg" /> -->
                ...
                <div id="icon-menu" class="d-xl-none">
